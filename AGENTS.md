...
- **已发布**：npm registry 最新 0.1.11（官方源）；GitHub 仓库 https://github.com/StephenHu09/dsh-file-mention（main + tag v0.1.11 已推送）；0.1.12~0.1.13 待发布（3fa7845 之后的修改已合并为单个 v0.1.13 提交）
